This notebook is intended as supplemental material for the paper "Efficient Preparation of Graph States via Local Clifford Operations with the Quotient Augmented Strong Split Tree".
...
(TBA) Please site this research as:
A (math paper)
B (physics paper)
